    ...
    return (
        <div className="flex justify-center items-center">
            ...
            >
                ...
                <h2 className="text-2xl font-bold mb-6 text-gray">
                    Añadir Cerveza
                </h2>

                <div className="flex flex-row m-full">
                    <div className="mb-4 w-3/6 pr-1">
                        <label
                ...
                <div className="mb-4">
                    ...
                    <input
                        ...
                        name="image"
                        onChange={handleChange}
                        className="file-input file-input-bordered w-full w-3/6 "
                    />
                </div>
